...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new dashboard.components.datechooser.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new dashboard.components.datechooser.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new dashboard.components.datechooser.Button();
        cmdPrevious = new dashboard.components.datechooser.Button();
        slide = new dashboard.components.datechooser.Slider();
        ...
        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dashboard/components/datechooser/forward.png"))); // NOI18N
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dashboard/components/datechooser/previous.png"))); // NOI18N
    ...
    private dashboard.components.datechooser.Button cmdForward;
    private dashboard.components.datechooser.Button cmdMonth;
    private dashboard.components.datechooser.Button cmdPrevious;
    private dashboard.components.datechooser.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private dashboard.components.datechooser.Slider slide;
