...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new dashboard.components.datechooser.Button();
        cmdTu = new dashboard.components.datechooser.Button();
        cmdWe = new dashboard.components.datechooser.Button();
        cmdTh = new dashboard.components.datechooser.Button();
        cmdFr = new dashboard.components.datechooser.Button();
        cmdSa = new dashboard.components.datechooser.Button();
        cmdSu = new dashboard.components.datechooser.Button();
        cmd1 = new dashboard.components.datechooser.Button();
        cmd2 = new dashboard.components.datechooser.Button();
        cmd3 = new dashboard.components.datechooser.Button();
        cmd4 = new dashboard.components.datechooser.Button();
        cmd5 = new dashboard.components.datechooser.Button();
        cmd6 = new dashboard.components.datechooser.Button();
        cmd7 = new dashboard.components.datechooser.Button();
        cmd8 = new dashboard.components.datechooser.Button();
        cmd9 = new dashboard.components.datechooser.Button();
        cmd10 = new dashboard.components.datechooser.Button();
        cmd11 = new dashboard.components.datechooser.Button();
        cmd12 = new dashboard.components.datechooser.Button();
        cmd13 = new dashboard.components.datechooser.Button();
        cmd14 = new dashboard.components.datechooser.Button();
        cmd15 = new dashboard.components.datechooser.Button();
        cmd16 = new dashboard.components.datechooser.Button();
        cmd17 = new dashboard.components.datechooser.Button();
        cmd18 = new dashboard.components.datechooser.Button();
        cmd19 = new dashboard.components.datechooser.Button();
        cmd20 = new dashboard.components.datechooser.Button();
        cmd21 = new dashboard.components.datechooser.Button();
        cmd22 = new dashboard.components.datechooser.Button();
        cmd23 = new dashboard.components.datechooser.Button();
        cmd24 = new dashboard.components.datechooser.Button();
        cmd25 = new dashboard.components.datechooser.Button();
        cmd26 = new dashboard.components.datechooser.Button();
        cmd27 = new dashboard.components.datechooser.Button();
        cmd28 = new dashboard.components.datechooser.Button();
        cmd29 = new dashboard.components.datechooser.Button();
        cmd30 = new dashboard.components.datechooser.Button();
        cmd31 = new dashboard.components.datechooser.Button();
        cmd32 = new dashboard.components.datechooser.Button();
        cmd33 = new dashboard.components.datechooser.Button();
        cmd34 = new dashboard.components.datechooser.Button();
        cmd35 = new dashboard.components.datechooser.Button();
        cmd36 = new dashboard.components.datechooser.Button();
        cmd37 = new dashboard.components.datechooser.Button();
        cmd38 = new dashboard.components.datechooser.Button();
        cmd39 = new dashboard.components.datechooser.Button();
        cmd40 = new dashboard.components.datechooser.Button();
        cmd41 = new dashboard.components.datechooser.Button();
        cmd42 = new dashboard.components.datechooser.Button();
    ...
    private dashboard.components.datechooser.Button cmd1;
    private dashboard.components.datechooser.Button cmd10;
    private dashboard.components.datechooser.Button cmd11;
    private dashboard.components.datechooser.Button cmd12;
    private dashboard.components.datechooser.Button cmd13;
    private dashboard.components.datechooser.Button cmd14;
    private dashboard.components.datechooser.Button cmd15;
    private dashboard.components.datechooser.Button cmd16;
    private dashboard.components.datechooser.Button cmd17;
    private dashboard.components.datechooser.Button cmd18;
    private dashboard.components.datechooser.Button cmd19;
    private dashboard.components.datechooser.Button cmd2;
    private dashboard.components.datechooser.Button cmd20;
    private dashboard.components.datechooser.Button cmd21;
    private dashboard.components.datechooser.Button cmd22;
    private dashboard.components.datechooser.Button cmd23;
    private dashboard.components.datechooser.Button cmd24;
    private dashboard.components.datechooser.Button cmd25;
    private dashboard.components.datechooser.Button cmd26;
    private dashboard.components.datechooser.Button cmd27;
    private dashboard.components.datechooser.Button cmd28;
    private dashboard.components.datechooser.Button cmd29;
    private dashboard.components.datechooser.Button cmd3;
    private dashboard.components.datechooser.Button cmd30;
    private dashboard.components.datechooser.Button cmd31;
    private dashboard.components.datechooser.Button cmd32;
    private dashboard.components.datechooser.Button cmd33;
    private dashboard.components.datechooser.Button cmd34;
    private dashboard.components.datechooser.Button cmd35;
    private dashboard.components.datechooser.Button cmd36;
    private dashboard.components.datechooser.Button cmd37;
    private dashboard.components.datechooser.Button cmd38;
    private dashboard.components.datechooser.Button cmd39;
    private dashboard.components.datechooser.Button cmd4;
    private dashboard.components.datechooser.Button cmd40;
    private dashboard.components.datechooser.Button cmd41;
    private dashboard.components.datechooser.Button cmd42;
    private dashboard.components.datechooser.Button cmd5;
    private dashboard.components.datechooser.Button cmd6;
    private dashboard.components.datechooser.Button cmd7;
    private dashboard.components.datechooser.Button cmd8;
    private dashboard.components.datechooser.Button cmd9;
    private dashboard.components.datechooser.Button cmdFr;
    private dashboard.components.datechooser.Button cmdMo;
    private dashboard.components.datechooser.Button cmdSa;
    private dashboard.components.datechooser.Button cmdSu;
    private dashboard.components.datechooser.Button cmdTh;
    private dashboard.components.datechooser.Button cmdTu;
    private dashboard.components.datechooser.Button cmdWe;
