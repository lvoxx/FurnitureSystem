package dashboard.components.textfield;
...
public class TextFieldAnimation extends JTextField {
    ...
    public TextFieldAnimation() {
        ...
        setSelectionColor(new Color(188, 188, 188));
        iconSearch = new ImageIcon(getClass().getResource("/dashboard/components/textfield/search.png"));
        iconClose = new ImageIcon(getClass().getResource("/dashboard/components/textfield/close.png"));
        iconLoading = new ImageIcon(getClass().getResource("/dashboard/components/textfield/loading.gif"));
